...
public class FeedbackUserController {
    ...
    public Page<FeedbackUserResponseDTO> searchFeedbackUser(@And({@Spec(path = "id", spec = Equal.class), @Spec(path = "rank", spec = Like.class), @Spec(path = "strengths", spec = Like.class), @Spec(path = "council.isFinished", constVal = "true", spec = Equal.class), @Spec(path = "isReturned", params = "isReturned", spec = Equal.class), @Spec(path = "toImprove", spec = Like.class), @Spec(path = "user.name", params = "userName", spec = Like.class), @Spec(path = "createDate", params = "createdAfter", spec = GreaterThanOrEqual.class), @Spec(path = "createDate", params = "createdBefore", spec = LessThanOrEqual.class), @Spec(path = "updateDate", params = "updatedAfter", spec = GreaterThanOrEqual.class), @Spec(path = "updateDate", params = "updatedBefore", spec = LessThanOrEqual.class)}) Specification<FeedbackUser> spec, Pageable pageable) {
