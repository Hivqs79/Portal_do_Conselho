    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/feedbacks/student").hasAnyRole("SUBPEDAGOGIC", "TEACHER", "SUPERVISOR")
                        ...
                        .requestMatchers(HttpMethod.GET, "/feedbacks/class").hasAnyRole("SUBPEDAGOGIC", "TEACHER", "SUPERVISOR")
