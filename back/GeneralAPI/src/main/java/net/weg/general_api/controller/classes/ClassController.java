package net.weg.general_api.controller.classes;
...
@AllArgsConstructor
@Tag(name = "Class Controller", description = "Controller para gerenciamento de registros das salas/turmas")
public class ClassController {
    ...
    @ApiResponse(responseCode = "200", description = "Class created", content = @Content(schema = @Schema(implementation = ClassResponseDTO.class), examples = @ExampleObject(value = "{\"id\":1,\"name\":\"New Class\",\"area\":\"HUMAN\",\"course\":\"Philosophy\",\"lastRank\":\"GOOD\",\"createDate\":\"2025-01-01T00:00:00\",\"updateDate\":\"2025-01-01T00:00:00\"}")))
    ...
    @ApiResponse(responseCode = "200", description = "Class updated", content = @Content(schema = @Schema(implementation = ClassResponseDTO.class), examples = @ExampleObject(value = "{\"id\":1,\"name\":\"Updated Class\",\"area\":\"EXACT\",\"course\":\"Computer Science\",\"lastRank\":\"GOOD\",\"createDate\":\"2025-01-01T00:00:00\",\"updateDate\":\"2025-01-02T00:00:00\"}")))
    ...
    @ApiResponse(responseCode = "200", description = "Class disabled", content = @Content(schema = @Schema(implementation = ClassResponseDTO.class), examples = @ExampleObject(value = "{\"id\":1,\"name\":\"Disabled Class\",\"area\":\"HEALTH\",\"course\":\"Medicine\",\"lastRank\":\"GOOD\",\"createDate\":\"2025-01-01T00:00:00\",\"updateDate\":\"2025-01-03T00:00:00\"}")))
    @ApiResponse(responseCode = "404", description = "Class not found")
    @ApiResponse(responseCode = "500", description = "Server error")
    ...
    @ApiResponse(responseCode = "200", description = "Class found", content = @Content(schema = @Schema(implementation = ClassResponseDTO.class), examples = @ExampleObject(value = "{\"id\":1,\"name\":\"Mathematics\",\"area\":\"EXACT\",\"course\":\"Engineering\",\"lastRank\":\"GOOD\",\"createDate\":\"2025-01-01T00:00:00\",\"updateDate\":\"2025-01-01T00:00:00\"}")))
    @ApiResponse(responseCode = "404", description = "Class not found")
    @ApiResponse(responseCode = "500", description = "Server error")
    ...
    @ApiResponse(responseCode = "200", description = "Students found", content = @Content(schema = @Schema(implementation = List.class), examples = @ExampleObject(value = "[{\"id\":1,\"name\":\"Student Name\",\"email\":\"student@email.com\",\"isRepresentant\":false,\"lastRank\":\"GOOD\",\"createDate\":\"2025-01-01T00:00:00\",\"updateDate\":\"2025-01-01T00:00:00\"}]")))
    @ApiResponse(responseCode = "404", description = "Class not found")
    @ApiResponse(responseCode = "500", description = "Server error")
