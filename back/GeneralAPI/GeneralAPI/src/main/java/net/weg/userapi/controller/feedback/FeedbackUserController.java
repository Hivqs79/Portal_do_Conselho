...
public class FeedbackUserController {
    ...
    public Page<FeedbackUserResponseDTO> searchFeedbackUser(
            @And({
                    ...
                    @Spec(path = "user.name", params = "userName", spec = Like.class),
    ...
    @GetMapping("/find/{id}")
    public ResponseEntity<List<FeedbackUserResponseDTO>> getAllFeedbackUserByStudent(@PathVariable Long id) {
